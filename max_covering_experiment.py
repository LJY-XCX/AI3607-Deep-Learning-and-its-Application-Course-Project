from max_covering_methods import *
import time
import xlwt
...
from max_covering_data import get_random_dataset, get_twitch_dataset, get_facebook_dataset
...
elif cfg.train_data_type == 'facebook':
    train_dataset = get_facebook_dataset()
